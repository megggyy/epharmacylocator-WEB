...
const FilterMedicinesByCategoryPerPharmacyGuest = () => {
            ...
            {filteredMedicines.map((item, index) => {
              ...
              return (
                <div
                  ...
                  onClick={() => navigate(`/viewpharmacymedicine?id=${item._id}&pharmacyId=${pharmacyId}`)}
                >
...
export default FilterMedicinesByCategoryPerPharmacyGuest;
