    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center text-teal-600 sm:justify-start">
          {/* logo */}
          <img src={logo2} alt="Your Logo"  className="h-20" />
        </div>

        <p className="mt-6 max-w-md text-center leading-relaxed sm:max-w-xs sm:text-left" style={{ color: 'white' }}>
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        <div className="text-center sm:text-left">
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              <a className="text-white transition hover:text-gray-700/75" href="/customer/about">
                About page
              </a>
            </li>
          </ul>
        ...
        <div className="text-center sm:text-left">
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              <a className="text-white transition hover:text-gray-700/75" href="/customer/contact"> Contact </a>
            </li>
          </ul>
        </div>
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span className="flex-1 text-white">epharmacy@gmail.com</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 text-white">09768918271</span>
              </a>
            </li>
